...
export function pick<O, K extends keyof O, R extends Record<string, any>>(obj: O, keys: K[] = [], rest?: R): Pick<O, K> & (R extends undefined ? object : R) {
  const newObj: any = {}
...
export function omit<T, K extends keyof T, R extends Record<string, any>>(object: T, keys: K[] = [], rest?: R): Omit<T, K> & (R extends undefined ? object : R) {
